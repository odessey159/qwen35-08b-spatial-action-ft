...
dataset_file="$repo/data/embspatial-bench/embspatial_bench.json"
output_dir="$run_dir/ood-embspatial-bench-cot-final-v2"
status_file="$repo/run_logs/embspatial_cot_v2_pre_post.status"
