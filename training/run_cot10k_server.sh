...
CONFIG="${PROJECT_DIR}/training/config.cot.10k.server.json"
STATUS="${PROJECT_DIR}/run_logs/cot10k_train.status"
...
if [[ -d outputs/qwen35-08b-cot-10k ]] &&
   find outputs/qwen35-08b-cot-10k -mindepth 1 -print -quit | grep -q .; then
